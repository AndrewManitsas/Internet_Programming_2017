		...
		<div class="w3-main" style="margin-left:340px;margin-right:40px">
			...
			<?php
				...
				if ($new_entry_pass1 == $new_entry_pass2)
				{
					...
					$sql = "INSERT INTO `accounts` (`user_id`, `username`, `password`, `name`, `surname`, `email`, `age`, `sex`) VALUES (NULL, '$new_entry_username', '$new_entry_pass1', '$new_entry_name', '$new_entry_surname', '$new_entry_email', '$new_entry_age', '$new_entry_sex')";
